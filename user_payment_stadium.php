...
$query = "select stadium.*,user_payment_stadium.id AS id_payment,user_payment_stadium.quantity,user_payment_stadium.bookstarttime,user_payment_stadium.bookendtime from stadium,user_payment_stadium where stadium.id = user_payment_stadium.id_stadium and user_payment_stadium.id_user = '{$id}' and user_payment_stadium.status = '待付款'";
